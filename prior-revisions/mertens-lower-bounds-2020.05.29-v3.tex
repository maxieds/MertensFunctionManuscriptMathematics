...
shows that there is some $x_0$ for each large enough $x \rightarrow \infty$ 
such that $|G^{-1}(x_0)| \gg |G_E^{-1}(x_0)| \gg |G_{\ell}^{-1}(x_0)|$ where 
$x_0 \rightarrow \infty$ as $x \rightarrow \infty$. So 
\begin{align} 
\notag 
\frac{|M(x)|}{\sqrt{x}} & \gg \frac{2 \left\lvert G_{\ell}^{-1}(x_0) \right\rvert}{\log\left(x_0\right)} \\ 
\label{eqn_MxGInvxLowerBound_stmt_v2} 
     & = \frac{2 C_{\ell,1} \cdot (\log\log x_0)^{4} \sqrt{\log\log\log x_0}}{ 
...
\frac{|M(x_{0,n})|}{\sqrt{x_{0,n}}} & \gg 
     \frac{2 C_{\ell,1} \cdot (\log\log \sqrt{x_{0,n}})^{4} \sqrt{ \log\log\log \sqrt{x_{0,n}} } }{ 
