...
\pagestyle{empty}
\pagestyle{fancy}
\fancyhead[RO,RE]{Maxie D. Schmidt -- Prepared for Kevin Ford -- \today} 
\fancyhead[LO,LE]{}
...
\textit{Draft prepared for Professors Kevin Ford, Michael Lacey and Bruce Reznick. \\ 
        \small I have checked these 
        results by careful reading, and re-reading at least twice myself with input from others, before 
        emailing this document. I will eventually also have organized \texttt{Mathematica} notebook 
        references to help with verfiying the claims and performing some of the more involved 
        integration and summation procedures. Please let me know if there is any other information or 
        clarifications I can provide to help you with understanding my argument and the new constructions. 
       }
...
compendia of the catalog references in \cite{CATALOG-INTDIRSERIES,CATALOG-LAMBERTSERIES}, we have notable identities of the form: 
...
$\operatorname{sgn}(h(n)) = \frac{h(n)}{|h(n)|} \in \{0, \pm 1\}$ denotes the sign, 
...
\subsubsection{Ideas towards why the proposed generalization could be useful} 
