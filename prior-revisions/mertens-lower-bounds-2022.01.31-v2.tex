...
to prove that for fixed $0 < r < P(2)^{-1}$ 
\[
...
formula for the average order of $C_{\Omega}(n)$: 
...
\operatorname{erfi}(z) = 
     %:= \frac{2}{\sqrt{\pi} \imath} \times \int_0^{\imath z} e^{t^2} dt = 
...
\caption{Comparisions of envelopes for the local extremum of the logarithmically scaled values of 
...
produce chaotic plots with no distinctive features.
