...
\newpage
\section{Preface: Notation for asymptotic relations} 
...
quasi-polynomial upper and lower bounds on $E_1(z)$ \footnote{ 
     ...
     $z \gg e^e$ is a matter of convenience we state this way here 
...
\newpage
\section{Bounding the Dirichlet inverse functions, $g^{-1}(n)$, on average} 
...
\newpage 
\section{A rigorous justification for the use so-called average case lower bounds 
         in proving Corollary \ref{cor_ThePipeDreamResult_v1}} 
