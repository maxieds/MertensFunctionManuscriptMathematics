...
Then we have using the standard recurrence relation for the Dirichlet inverse function 
$h^{-1}$ with $\chi_{\mathbb{P}} = \omega \ast \mu$ that 
\begin{align} 
\notag
...
(and the DGF of a convolution is a product of the component DGFs). 
