...
Define the function 
\[
\widehat{G}(z) := \frac{1}{\Gamma(1+z)} \left(\frac{6e^{-P(2)}}{\pi^2}\right)^z, 
...
\[
z \leq \left(\frac{\Gamma(\log\log x + 1) (\log x)}{\sqrt{2\pi \log\log x}}\right)^{MD_0+B_0} 
