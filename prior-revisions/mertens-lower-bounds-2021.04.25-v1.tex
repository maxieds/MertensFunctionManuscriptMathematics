...
\begin{align*}
\frac{1}{x} \times \left\lvert \sum_{k > \log\log x} (-1)^{k} \pi_k(x) \right\rvert & \ll \left\lvert 
     \sum_{0 \leq k \leq \log x} (-1)^{k} \left(\Phi\left(\frac{k+1}{\sqrt{\log\log x}}\right) - 
     \Phi\left(\frac{k}{\sqrt{\log\log x}}\right)\right) \right\rvert \\ 
     & \ll \sqrt{\log\log x} \times \left\lvert 
     \sum_{0 \leq k \leq \log x} (-1)^{k} \left(\frac{e^{-\frac{(k+1)^2}{\log\log x}}}{k+1} - 
     \frac{e^{-\frac{k^2}{\log\log x}}}{k}\right) \right\rvert \\ 
     & \ll \frac{\sqrt{\log\log x}}{\log x} \times \left\lvert \sum_{0 \leq k \leq \log x} 
     \frac{(-1)^k}{k(k+1)} \right\rvert \ll \frac{\sqrt{\log\log x}}{\log x}. 
\end{align*}
