...
%\frac{1}{x} \times \#\left\{2 \leq n \leq x: -z \leq |g(n)| - 
%	\frac{1}{n} \times \sum_{k \leq n} |g(k)| \leq z\right\} & = 
%	\Phi\left(\frac{\log\left(\frac{\pi^2 (z+1)}{6\log\left(\sigma_x \cdot |z+1|\right)}\right) - 
%	\mu_x}{\sigma_x}\right) + o(1).
\end{align*} 
\end{theorem}
...
\frac{1}{x} \times 
	...
	%\#\left\{2 \leq n \leq x: \frac{\log C_{\Omega}(n) - \mu_x}{\sigma_x} \leq z\right\} = 
	%\Phi\left(\frac{z + 1}{\log\left(\sigma_x \cdot |z + 1|\right)}\right) + o(1).
\end{equation}
\end{theorem} 
...
\end{equation}
%If $s \log s = T$, then $s = \frac{T}{W(T)} \sim \frac{T}{\log |T|}$ 
%as $T \rightarrow \infty$. 
%The function $W(y)$ denotes the principal branch of the Lambert $W$ function which is defined 
%such that $x = W(y)$ if and only if $xe^{x} = y$ for $x, y \in [0, \infty)$. 
...
%	\Phi\left(\frac{z + 1}{\log\left(\sigma_x \cdot |z + 1|\right)}\right), 
%	\text{ for any } z \in (-\infty, \infty), \text{ as } x \rightarrow \infty. 
\mathbb{P}\left[\frac{\log C_{\Omega}(N(x)) - \mu_x}{\sigma_x} \leq z\right] \sim 
	\Phi\left(z\right), \text{ for any } z \in (-\infty, \infty), \text{ as } x \rightarrow \infty.
	\qedhere
\]
\end{itemize}
\end{proof}
