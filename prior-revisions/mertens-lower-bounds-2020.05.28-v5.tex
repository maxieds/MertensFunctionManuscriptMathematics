...
\[
\int_{e^e}^{n} \frac{(\log\log t)^m}{t} \sim (\log n) (\log\log n)^{m}, 
...
\end{align} 
where $\delta_x \in \left(-\frac{1}{2}, \frac{1}{2}\right)$, and 
...
\begin{align*} 
\frac{|M(x)|}{x} \gg \log\left(x\right) (1 + o(1)) 
...
for all sufficiently large $x \geq e^e$. 
