...
\]
As $x \rightarrow \infty$, we compute that the condition $k\log k > (1+\varepsilon) \mu_x$ is true when 
...
should predict the regularity by limiting distribution we find in 
