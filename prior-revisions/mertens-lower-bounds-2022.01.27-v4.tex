...
\caption{$\mu \equiv \mu(x) = \sqrt{\log\log x}$ and 
	 $\sigma \equiv \sigma(x) =\sqrt{\log\log x}$ $\phantom{(\log x)} \phantom{(\log x)()}$} 
\end{subfigure}
...
\centering
\begin{subfigure}{0.47\textwidth}
\fbox{\includegraphics[width=\textwidth]{images/FigureHistogramFit1_v3-GInvFunctionSequenceCalculations.png}}
\end{subfigure}\hfil
\centering
\begin{subfigure}{0.47\textwidth}
\fbox{\includegraphics[width=\textwidth]{images/FigureHistogramFit2_v3-GInvFunctionSequenceCalculations.png}}
\end{subfigure}
\captionsetup{justification=centering}
\caption{$\mu \equiv \mu(x) = (\log x) \sqrt{\log\log x}$ and $\sigma \equiv \sigma(x) = \sqrt{(\log x) (\log\log x)}$} 
\end{subfigure}

\caption{Histograms representing the CDF of the distribution of 
         $\sigma^{-1} \left(|g(n)| - \frac{1}{n} \times \sum_{k \leq n} |g(k)| - \frac{6\mu}{\pi^2}\right)$  
         for $n \leq x$. 
         The dashed lines show the approximate fit by the CDF 
