...
limiting distribution that results by composing the respective first and second moments of the 
function $C_{\Omega}(n)$ with $\log x$ at large $x$ (\cf \cite{CLT-RANDOM-ORDERED-FACTS-2011}). 
We have arrived at the central second moment of $C_{\Omega}(n)$ 
