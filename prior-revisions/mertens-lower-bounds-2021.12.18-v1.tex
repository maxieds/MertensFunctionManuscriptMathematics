...
\newglossaryentry{NormalCDFFunc}{
    ...
    description={For $z \in \mathbb{R}$, we take the cumulative density function 
                 ...
                 Any random variable whose values are distributed according to the CDF $\Phi(z)$ 
                 (without scaled mean and variance parameters) 
                 are said to have the distribution $\mathcal{N}(0, 1)$. },
    type={symbols},
    name={Asymptotic relation symbol}
    }
...
\newglossaryentry{GGTildeFHatGHatBivariateFunctions}{
    ...
    description={The functions $\mathcal{G}(z)$ and $\widetilde{\mathcal{G}}(z)$ are defined for 
                 ...
                 by the infinite products over the primes given on 
...
\newglossaryentry{ErrorFunctionsErfErfiz}{
    ...
    description={The function 
                 ...
                 standard normal distribution (defined in the glossary below) for any $z \in (-\infty, +\infty)$ through the 
                 ...
                 $\operatorname{erfi}(z) = \operatorname{erf}(\imath z) := 
                  \frac{1}{\imath\sqrt{\pi}} \times \int_0^{\imath z} e^{t^2} dt$ for $z \in [0, +\infty)$. 
...
%\[
%\sum_{n \geq 1} \frac{C_{\Omega}(n)}{n^s} = \frac{1}{1-P(s)}, \text{ for } \Re(s) > 1, 
%\]
we have that 
\[
