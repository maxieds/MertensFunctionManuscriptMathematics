...
\notag 
     ...
     \mathtext{ as } x \rightarrow \infty. 
\end{align}
The maximum in the previous equations is attained when $t = \frac{3}{2} \log\log x$. 
This shows that 
\begin{align}
\notag 
\frac{x}{\log x} \times |E_1(x)| & \ll \frac{x}{\log x} \times |I_1(x)| 
     \ll 
     x (\log x)^{\frac{1}{2}\left(1-3\log\left(\frac{3}{2}\right)\right)} 
     (\log\log x)^{\frac{3}{2}} (\log\log\log x) \\  
