...
\[
\widehat{T}_k(x) \ll x^{0.905466} (\log x)^{k-2}, 
	\text{ as } x \rightarrow \infty. 
\]
...
S_{2,\Omega}(n) & = V_{\Omega}^2(n) - E_{\Omega}(n)^2 = 
...
\begin{align}
\notag
V_{\Omega}^2(n) & \sim B_0^2 \left(3E_{\Omega}(n)^2 - 
...
z \ll \left(\frac{\Gamma(\log\log x + 1) (\log x)}{\sqrt{2\pi \log\log x}}\right)^{ 
     1 + \sqrt{2} \operatorname{erf}^{-1}\left(|2M-1|\right)} \textbf{(TODO)}.
\]
