...
$C_k(n)$ whenever $k \geq 1$ and as $n \rightarrow \infty$. 
\end{proof} 
...
$g^{-1}(n)$ when $n$ is large are easier to work with than an exact result -- another key feature of why 
analytic number theory has such useful, beautiful constructions to start with. 
\end{proof} 
...
\end{theorem} 
\begin{proof}[Proof Initial Sketch: Logarithmic scaling of parameters to the accurate order] 
