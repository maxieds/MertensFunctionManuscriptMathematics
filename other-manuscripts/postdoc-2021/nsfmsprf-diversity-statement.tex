...
%\subsection{A personal tribute to RBG: Security software contributions over the pandemic}
...
%\subsection{Optikey project: ``Big Hacker'' keyboard designs for users with disability} 
